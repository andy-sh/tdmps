 ...
 * Date: 2012-07-03
 * Rev:  1.3.2
 * $Id: jquery.mcdropdown.js 208 2013-02-04 04:19:10Z liqt $
 */
	...
	var defaults = {
		...
		, inputHiddenName: ""		   // @hack为生成的input hidden指定名称
	};
	...
	$.mcDropDownMenu = function(el, list, options){
		...
		// create the div to wrap everything in @hack
		$divInput = $('<div class="mcdropdown"><a href="#" tabindex="-1"></a><input type="hidden" name="' + (settings.inputHiddenName || el.id) + '" id="' + (el.id || el.name) + '" /></div>')
