...
* Version 0.3
* $Id: jquery.simple.tree.js 4 2012-07-18 06:40:23Z liqt $
*/
...
$.fn.simpleTree = function(opt){
	return this.each(function(){
		...
		TREE.setTrigger = function(node){
			//@note: 修改原插件的路径为scap系统路径
			$('>span',node).before('<img class="trigger" src="base/library/jquery/plugins/simpletree/images/spacer.gif" border=0>');
