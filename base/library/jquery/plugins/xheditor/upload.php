 ...
 * $Id: upload.php 73 2013-01-24 09:40:42Z liqt $
 */
header('Content-Type: text/html; charset=UTF-8');

$inputName='filedata';//表单文件域name
$attachDir='../../../../../media';//上传文件保存路径，结尾不要带/
...
if($err==''){
	...
	if(preg_match('/'.str_replace(',','|',$upExt).'/i',$extension))
	{
		...
		else
		{
			...
			$urlPath = $arr_url[0]."/media/".$attachSubDir."/".$newFilename;
			
			$targetPath=jsonString($urlPath);
			if($immediate=='1')$urlPath='!'.$urlPath;
			
			if($msgType==1)$msg="'$urlPath'";
